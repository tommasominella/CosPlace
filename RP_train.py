...
val_ds = TestDataset(args.val_set_folder, positive_dist_threshold=args.positive_dist_threshold) #validation dataset, val_ds dovrebbe essere il numero di immagini nel database
